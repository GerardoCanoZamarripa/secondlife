...
class Producto
{
  function verProductos()
  {
    ...
    $consulta = "SELECT p.id_producto as id_producto, p.nombre as nombre, p.precio as precio, v.nombre as nomV, i.nombre as imagen  FROM productos p, vendedores v, imagenes i WHERE i.id_producto = p.id_producto AND p.id_vendedor = v.id_vendedor AND i.nombre LIKE ('%1____')";
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-new-arrival mb-50 text-center">
                            <div class="popular-img">
                                <img src="assets/img/productos/$registro[nomV]/$registro[imagen]" alt="">
                            </div>
                            ...
                            <div class="s_product_text">
                                ...
                                <div class="card_area">
                                    ...
                                    <div class="add_to_cart">
                                        <form action="product_details.php" method="post" name="formulario1">
                                          <input type="hidden" name="p" value="$id" />
                                          <input type="hidden" name="i" value="$imagen" />
                                          <a href="javascript:enviar_formulario()" class="btn">Agregar al carrito</a>
                                        </form>
  ...
  {
    include("conexion.php");
    $consulta = "SELECT p.nombre as prod, p.precio as prec, v.nombre as nomV, i.nombre as imagen  FROM favoritos f, productos p, vendedores v, usuarios u, imagenes i WHERE f.id_producto = p.id_producto AND p.id_vendedor = v.id_vendedor AND f.id_usuario = u.id_usuario AND i.id_producto = p.id_producto AND f.id_usuario = ?";
    $resultado = $pdo->prepare($consulta);
          ...
          print <<< EOT
            <tr>
              <td>
                  <div class="media">
                      <div class="d-flex">
                          <img src="assets/img/gallery/productos/$nomV/$favorito[imagen]" alt="" />
                      </div>
                      <div class="media-body">
                          <p>$favorito[prod]</p>
                      </div>
