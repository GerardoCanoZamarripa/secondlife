                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-8 col-md-8">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="fadeInUp" data-delay=".4s" >Usuarios</h1>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn" href="../../formularioUsuario.html">Editar</a>
                                    </td>
                                    <td>
                                ...
                                <tr class="bottom_button">
                                    ...
                                    <td>
                                        <div class="cupon_text float-right">
                                            <a class="btn" href="../../actualizarUsuario.html">Agregar Usuarios</a>
                                        </div>
                                    </td>
                                </tr>
                                        </div>
