                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-8 col-md-8">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="fadeInUp" data-delay=".4s" >Vendedores</h1>
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-body">
                                                    <h2>Juan Manuel Rosa</h2>
                                                </div>
                                            </div>
                                        
                                    </td>
                                    <td>
                                        <a class="btn" href="../../formEditVen.html">Editar</a>
                                    </td>
                                    <td>
                                ...
                                <tr class="bottom_button">
                                    ...
                                    <td>
                                        <div class="cupon_text float-right">
                                            <a class="btn" href="../../formVen.html">Agregar Vendedor</a>
                                        </div>
                                    </td>
                                </tr>
                                        </div>
